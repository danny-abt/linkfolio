  ...
  return (
    <section id="projects" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Projets</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="card-glow group bg-card border border-card-border rounded-2xl p-6"
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-2 py-1 rounded-md bg-accent/10 text-accent-light text-xs font-mono"
                  >
                    {tag}
                  </span>
                ))}
